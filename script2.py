# This is the same thing as script.py but for a RTL-SDR device with a different serial number
...
sdr = RtlSdr(serial_number='77771111153705700')
sdr.sample_rate = 2.4e6  # Hz

sdr.freq_correction = 60   # PPM
sdr.gain = 30              # dB

# Set the frequency range to scan (392.5MHz-395.0MHz)
start_freq = 3925e5  # Hz
end_freq = 395e6  # Hz
...
while True:
    ...
    if spectrum[peak_index] > squelch_level and peak_freq_mhz in blacklist:
        ...
        print(f"Peak frequency detected but not enough difference between samples...: {peak_freq_mhz} MHz")
